...
<%@ page import="java.sql.Connection,java.sql.ResultSet,java.sql.DriverManager,java.sql.PreparedStatement,java.sql.ResultSet,javax.servlet.*"%>
<!DOCTYPE html>
<html>
<head>
    ...
    <script src="js/meeting-notes.js" type="text/javascript"></script>
    <script src="vendor/Semantic-UI/semantic.min.js"></script>
    <title>Meeting Notes-Vsoft</title>
</head>
<body>
	<%
    ...
    <div class="page-content">
      ...
      <form class="meetingclass">
        <div class="meeting-form-title">
          Title
        </div>
          <div class="meeting-input-form">
            <input class="input100" type="text" id="title" placeholder="Enter your Title here" required>
          ...
          <div class="meeting-des-form">
            <input class="input100" type="text" id="description" placeholder="Enter your description here" required>
            <span class="focus-input100"></span>
            <span class="symbol-input100">
          ...
          <div class="meeting-des-form">
            <input class="input100" type="text" id="link" placeholder="paste your link here" required>
            <span class="focus-input100"></span>
            <span class="symbol-input100">
          ...
          <div class="meeting-people-form">
			<select name="peoples" class="ui fluid search dropdown" multiple="multiple" id="multi-select">
		        <option value="">Search the peoples here</option>
		        <% 
          ...
          <div class="date">
            <input class="date-style" type="date" id="date" required>
          </div>
          <div class="meeting-form-title">
            Start and End time
          </div>
          <div class="time">
            <input class="time-style" type="time" id="starttime" required>
            <div class="header">
              <i class="fa fa-arrow-right" aria-hidden="true"></i>
            </div>
            <input class="time-style" type="time" id="endtime" required>
          </div>

          <div class="container-login100-form-btn">
            <div class="close-icon">
              <button class="login100-form-btn" id="Createmeeting">
                Create a Meeting
              </button>
            </div>
          </div>
